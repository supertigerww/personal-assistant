...
def settings(tmp_path):
    return Settings.model_construct(
        ...
        media_send_probability_normal=0.40,
        media_send_probability_intense=0.55,
        media_send_probability_aftercare=0.0,
        media_send_probability_paused=0.0,
        media_random_fallback_probability=0.28,
        media_force_every_n_turns=5,
        scene_image_auto_probability_normal=0.58,
        scene_image_auto_probability_intense=0.72,
        scene_image_force_every_n_turns=2,
